document.addEventListener('DOMContentLoaded', () => {
    ...
    function createHeart() {
        ...
        heart.style.top = '-5vh'; // Start above
        heart.style.fontSize = Math.random() * 20 + 20 + 'px';
        heart.style.animationDuration = Math.random() * 2 + 3 + 's'; // Falling speed
    ...
    // Create hearts/flowers periodically - RAINING!
    setInterval(() => {
        createHeart();
        createHeart();
    }, 100);
...
function initCelebration() {
    // Confetti effect for yes page - HEARTS & ROSES RAIN!
    const emojis = ['❤️', '🌹', '💖', '🌷', '💘', '💝'];
